...
def compare_models():
    ...
    if len(versions) < 2:
        ...
        raise Exception("Need at least two model versions")
    ...
    v1_accuracy = get_model_metric(v1)

    v2_accuracy = get_model_metric(v2)

    print("Version 1 Accuracy:", v1_accuracy)

    print("Version 2 Accuracy:", v2_accuracy)
