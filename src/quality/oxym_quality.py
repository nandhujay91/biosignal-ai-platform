...
class OxymQuality(BaseQuality):
    """
    Production Pulse Oximeter Quality Assessment.
    """
    ...
    def _check_low_variance(self, signal: Signal, report: QualityReport) -> None:
    ...
    def _finalize_report(self, report: QualityReport) -> None:
